...
//			ContJdbcSearch contsearch = insert.getController();
	...
	private void addButtonToTable() {
		TableColumn<PharmVO, Void> colBtn2 = new TableColumn<PharmVO,Void>("상세보기");
					...
					// 버튼을 눌렀을 때 실행할 action
					{
						btn2.setOnAction(e -> {
							try {
								...
								List<PharmVO> aa = calldate();
								ykMap.vo.PharmVO aa1 = calldate().get(0);
								System.out.println(aa1.getPharm_name());
