...
public class ControllerMember {
    ...
    @FXML
    void memberDelete(ActionEvent event) {
    ...
    @FXML
    void memberOk(ActionEvent event) {
    	// 평상시에는 비활성화 
    ...
    //서비스 객체 변수 선언  _ 선생님
    private MemberServiceImpl service;   // 생성자를 만들던가 initailize에 service객체를 생성한다. 
    ...
    void initialize() {
    	...
    	//tableview의 각 컬럼과 vo객체의 멤버변수를 매핑 시킨다. 
